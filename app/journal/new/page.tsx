    ...
    <div className="premium-page">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <section className="premium-panel animate-fade-in">
          <textarea value={content} onChange={(e) => setContent(e.target.value)} placeholder="What's on your mind?" className="w-full min-h-[200px] border-[var(--border)] bg-[#080b0e] text-[var(--text)] placeholder:text-[var(--text-tertiary)] text-sm resize-y" required />
          ...
          <input type="text" value={tags} onChange={(e) => setTags(e.target.value)} placeholder="Tags (comma separated)" className="w-full mt-3 border-[var(--border)] bg-[#080b0e] text-[var(--text)] placeholder:text-[var(--text-tertiary)] text-sm" />
        </section>
