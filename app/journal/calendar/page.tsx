...
export default function JournalCalendarPage() {
  return (
    <div className="premium-page animate-fade-in"><div className="premium-header animate-fade-in"><div className="premium-kicker">Browse</div><h1 className="premium-title">Calendar</h1><p className="premium-subtitle">Browse entries by date</p></div>
