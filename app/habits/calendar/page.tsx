...
export default function HabitCalendarPage() {
  return (
    <div className="premium-page"><div className="premium-header animate-fade-in"><div className="premium-kicker">Overview</div><h1 className="premium-title">Calendar</h1><p className="premium-subtitle">Monthly habit completion view</p></div>
