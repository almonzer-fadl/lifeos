...
export default function UpcomingPage() {
  return (
    <div className="premium-page animate-fade-in"><div className="premium-header animate-fade-in"><div className="premium-kicker">Schedule</div><h1 className="premium-title">Upcoming</h1><p className="premium-subtitle">Scheduled and due tasks</p></div>
